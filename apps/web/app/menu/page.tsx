...
export default function HomePage() {
        ...
        <div className="min-h-screen flex items-center justify-center gridline-background">
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="h-[16em] w-[18em] border-2 border-[rgba(75,30,133,0.5)] rounded-[1.5em] bg-gradient-to-br from-[rgba(75,30,133,1)] to-[rgba(75,30,133,0.01)] text-white font-nunito p-[1em] flex justify-center items-left flex-col gap-[0.75em] backdrop-blur-[12px]"
                      onMouseEnter={() => setHeaderText("Good choice...")}
                      onMouseLeave={() => setHeaderText("SELECT A ROOM")}>
  <div>
  ...
  <button
    ...
    onClick={() => {router.push("/chat/strangers"); setHeaderText("Good choice...")}}
  >
    <p>Start Chatting</p>
    <svg
    ...
    >
      ...
      ></path>
                    ...
                    >
                        <button
                            onClick={() => {setIsLoadingPublicRoom(true); setHeaderText("Good choice..."); setTimeout(() => router.push("/chat/public"), 1000)}}
                    ...
                    >
                        <button
                            onClick={() => {setIsLoadingPrivateRoom(true); setHeaderText("Good choice..."); setTimeout(() => router.push("/chat/private"), 1000)}}
                            className="block w-full h-full py-10 px-6 text-2xl font-semibold text-white transform transition duration-300 hover:scale-105 focus:outline-none"
                        >
